...
class Repay_with_collateral_adapter extends _i1.GeneratedContract {
  Repay_with_collateral_adapter({
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> swapAndRepay(
    ({
      _i1.EthereumAddress collateralAsset,
      _i1.EthereumAddress debtAsset,
      BigInt collateralAmount,
      BigInt debtRepayAmount,
      BigInt debtRateMode,
      BigInt buyAllBalanceOffset,
      _i2.Uint8List paraswapData,
      dynamic permitSignature
    }) args, {
    required _i1.Credentials credentials,
    _i1.Transaction? transaction,
  }) async {
    final function = self.abi.functions[10];
    assert(checkSignature(function, '4db9dc97'));
    final params = [
      args.collateralAsset,
      args.debtAsset,
      args.collateralAmount,
      args.debtRepayAmount,
      args.debtRateMode,
      args.buyAllBalanceOffset,
      args.paraswapData,
