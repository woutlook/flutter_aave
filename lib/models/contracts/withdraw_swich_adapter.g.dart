...
class Withdraw_swich_adapter extends _i1.GeneratedContract {
  ...
  Future<String> withdrawAndSwap(
    ...
    assert(checkSignature(function, '5fd73e07'));
    final params = [
