...
class Collector extends _i1.GeneratedContract {
  ...
  Future<String> changeAdmin(
    ({_i1.EthereumAddress newAdmin}) args, {
    required _i1.Credentials credentials,
    _i1.Transaction? transaction,
  }) async {
    final function = self.abi.functions[2];
    assert(checkSignature(function, '8f283970'));
    final params = [args.newAdmin];
    return write(
      credentials,
      transaction,
      function,
  ...
  Future<String> initialize(
    ...
    assert(checkSignature(function, 'cf7a1d77'));
    final params = [
      args.logic,
      args.admin,
      args.data,
